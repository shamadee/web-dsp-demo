    ...
    fetch('./lib/webdsp_c.wasm')
      ...
      .then(buffer => {
        ...
        script.onload = function () {
          ...
          wam['sunset'] = bindLastArgs(wam['multiFilter'], 4, mag, mult, adj);
          wam['analogTV'] = bindLastArgs(wam['multiFilter'], 7, mag, mult, adj);
          wam['emboss'] = bindLastArgs(wam['multiFilter'], 1, mag, mult, adj);
          wam['urple'] = bindLastArgs(wam['multiFilter'], 2, mag, mult, adj);
